...
IAtom * distributionUniformAtom;
IAtom * distributionBinomialAtom;
IAtom * distributionNegativeBinomialAtom;
IAtom * distributionGeometricAtom;
IAtom * distributionPoissonAtom;
IAtom * _dot_Atom;
IAtom * dynamicAtom;
IAtom * ebcdicAtom;
IAtom * eclrtlAtom;
...
MODULE_INIT(INIT_PRIORITY_HQLATOM)
{
    ...
    MAKEATOM(distributionUniform);
    MAKEATOM(distributionBinomial);
    MAKEATOM(distributionNegativeBinomial);
    MAKEATOM(distributionGeometric);
    MAKEATOM(distributionPoisson);
    MAKESYSATOM(dot);
    MAKEATOM(dynamic);
    MAKEATOM(ebcdic);
    MAKEATOM(eclrtl);
